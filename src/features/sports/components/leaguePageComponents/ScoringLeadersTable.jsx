import { useScoringLeadersById } from "../../hooks/LeagueHooks.jsx";
import { useNavigate } from "react-router-dom";

export default function ScoringLeadersTable({ leagueId }) {
    const { data, loading, err } = useScoringLeadersById(leagueId);
        ...
        <div className="overflow-x-auto rounded-xl p-4 shadow-md">
            <table className="table table-zebra w-full text-sm sm:text-base">
                ...
                <tr>
                    ...
                    <th className="text-center">Mål</th>
                </tr>
                </thead>
                <tbody>
